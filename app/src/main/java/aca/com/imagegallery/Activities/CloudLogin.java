...
public class CloudLogin extends AppCompatActivity {
   ...
   /* private View.OnClickListener mOnClickListener = new View.OnClickListener() {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.cloud_loggin);
        ...
        findViewById(R.id.cloud_login_login_button).setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        findViewById(R.id.cloud_login_register_button).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View pView) {
