...
public class CloudRegistration extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mNameEditText = (EditText)findViewById(R.id.cloud_registration_name_edt);
        mEmailEditText = (EditText)findViewById(R.id.cloud_registration_mail_edt);
        mPasswordEditText = (EditText)findViewById(R.id.cloud_registration_password_edt);
        mPasswordRepeatEditText = (EditText)findViewById(R.id.cloud_registration_password_retype_edt);
        ...
        findViewById(R.id.cloud_registration_registration_button).setOnClickListener(new View.OnClickListener() {
            @Override
